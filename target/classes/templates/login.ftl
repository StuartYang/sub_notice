...
<body class="loginBody">
	<form class="layui-form">
		...
		<div class="layui-form-item input-item">
			...
			<input type="text" placeholder="请输入用户名" autocomplete="off" id="userName" value="yangxudong" name="userName" class="layui-input" lay-verify="required|userName">
		</div>
		<div class="layui-form-item input-item">
			<label for="password">密码</label>
			<input type="password" placeholder="请输入密码" autocomplete="off" id="password" value="yangxudong" name="password"  class="layui-input" lay-verify="required|password">
		</div>
