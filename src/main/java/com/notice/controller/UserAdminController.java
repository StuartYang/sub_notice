...
import com.notice.model.JqgridBean;
import com.notice.model.PageRusult;
import com.notice.service.TroleService;
import com.notice.service.TuserService;
import com.notice.service.TuserroleService;
...
public class UserAdminController {
    ...
    @RequiresPermissions(value = {"通知管理"})
    ...
    @RequiresPermissions(value = {"系统通知"})
    public String sysNotice(HttpServletRequest request)  {
		return "notice/sysNotice";
    }
    /*
     * 测试comment界面
     */
    @RequestMapping(value = "/comment")
    @RequiresPermissions(value = {"评论管理"})
    ...
    public Map<String, Object> list(JqgridBean jqgridbean) {
        ...
        resultmap.put("msg", "");
        resultmap.put("count",String.valueOf(pageRusult.getPages()));
